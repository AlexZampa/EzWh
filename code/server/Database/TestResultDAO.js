...
class TestResultDAO{
    ...
    resetTable = async () => {
        try {
            ...
            res = await this.connectionDB.DBexecuteQuery('CREATE TABLE IF NOT EXISTS "TestResult" ("id" INTEGER NOT NULL UNIQUE, "rfid" TEXT NOT NULL, "idTestDescriptor" INTEGER NOT NULL, "Date" TEXT NOT NULL, "Result" TEXT NOT NULL, PRIMARY KEY("id"));');
        } catch (err) {
            throw err;    
        }
    };
